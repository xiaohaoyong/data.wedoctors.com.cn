...
/* @var $searchModel app\models\SubscriptionSearchModel */
...
'columns' => [
            ...
            [
                ...
                'value' => function($data)
                {
                    return \app\models\Subscription::$levelText[$data->level];
                }
            ],
            [
                'attribute' => 'type',
                'value' => function($data)
                {
                    return \app\models\Subscription::$typeText[$data->type];
                }
            ],
            // 'addtime:datetime',
            // 'img',
