...
class UserInfo extends UserDb
{
    ...
    {
        return [
            [['userid','sex', 'age', 'phone', 'hospitalid', 'subject_b', 'subject_s', 'title', 'province', 'county', 'city', 'atitle', 'otype'], 'required'],
            [['userid', 'sex', 'age', 'phone', 'hospitalid', 'subject_b', 'subject_s', 'title', 'province', 'county', 'city', 'atitle', 'otype'], 'integer'],
            [['name'], 'string', 'max' => 15],
            [['intro', 'avatar', 'skilful'], 'string', 'max' => 150],
            [['idnum'], 'string', 'max' => 18],
            // 若 "level" 为空，则设其为 1
            ['idnum', 'default', 'value' => 'x'],
            ['phone', 'unique'],
        ];
    }
