...
//        $this->clientOptions['format']='yyyy-mm-dd';
        $this->clientOptions['weekStart']=1;
        $this->clientOptions['todayBtn']=1;
        $this->clientOptions['autoclose']=1;
        $this->clientOptions['todayHighlight']=1;
        $this->clientOptions['startView']=2;
        $this->clientOptions['forceParse']=0;
        $this->clientOptions['showMeridian']=1;
