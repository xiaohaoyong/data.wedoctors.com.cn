    ...
    public function run() {
        ...
        if ($this->hasModel()) {
            switch ($this->editorType) {
                ...
                default:
                    return Html::activeTextarea($this->model, $this->attribute, ['id' => $this->id,'value'=>$this->value]).
                   '<input type="text" readonly="true" style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px" name="cont" value="">';
                    break;
            }
        } else {
            switch ($this->editorType) {
...
EOT;
            ...
            default:
                ...
                $clientOptions .=',"afterBlur":function(){this.sync();}}';
